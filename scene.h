...
static inline void triangle_array_init(TriangleArray *scene) {
    scene->data = NULL;
    scene->size = 0;
    scene->capacity = 0;
}

static inline void triangle_scene_push_back(TriangleArray *scene, Triangle triangle) {
...
static inline void triangle_scene_free(TriangleArray *scene) {
    free(scene->data);
    scene->data = NULL;
    scene->size = 0;
    scene->capacity = 0;
...
static inline void mesh_add_quad(TriangleArray *scene, Vector3 v0, Vector3 v1, Vector3 v2, Vector3 v3) {
    Triangle t1 = {v0, v1, v2};
    Triangle t2 = {v0, v2, v3};
    triangle_scene_push_back(scene, t1);
    triangle_scene_push_back(scene, t2);
}

static inline void mesh_add_triangle(TriangleArray *scene, Vector3 v0, Vector3 v1, Vector3 v2) {
    Triangle t = {v0, v1, v2};
    triangle_scene_push_back(scene, t);
}

static inline void mesh_add_quad_tesselated(TriangleArray *scene, Vector3 v0, Vector3 v1, Vector3 v2, Vector3 v3, int divs) {
...
static inline void mesh_add_box(TriangleArray *scene, float centre_x, float centre_y, float centre_z,
...
static void build_scene(TriangleArray *scene) {
